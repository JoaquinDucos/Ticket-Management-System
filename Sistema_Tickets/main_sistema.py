...
while n>=1 and n<=11:
        ...
        if n == 1:                
            ...
            try: 
                lista_usr= usuario_vip_alfabet(matVentas)
                print("\nLista de usuarios VIP: ", list_to_str_comas(lista_usr), "\n")

                lista_ord = burbujeo(lista_usr)
                print("Lista de usuarios VIP ordenada: ",list_to_str_comas(lista_ord),"\n")

                print_venta = imprimir_venta(lista_usr, matVentas)    
